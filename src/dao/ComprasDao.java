...
public class ComprasDao {
    ...
    public boolean registarCompra(Compra cm) throws Exception 
    {
        iniciarOperacion();
        sesion.save(cm);
        tx.commit();
    ...
    public boolean actualizarCompra(Compra cm) throws Exception 
    {
        iniciarOperacion();
        sesion.update(cm);
        tx.commit();
    ...
    public List<Object[]> listarCompras() throws Exception 
    {
        iniciarOperacion();
    ...
    public boolean eliminarCompra(Compra cm) throws Exception {
        iniciarOperacion();
        sesion.delete(cm);
        tx.commit();
        sesion.close();
    ...
    public Compra buscarCompra(int id) throws Exception {
        Compra cm = null;
        iniciarOperacion();
        Query query = sesion.createQuery("From Compra Where idcompra=?");
        query.setInteger(0, id);
        cm = (Compra) query.uniqueResult();
        sesion.close();
        return cm;
    }
