...
public class vtnLogin extends javax.swing.JFrame {
    ...
    public void setIcono()
    {
        ...
        vtnPrincipal.lbmAvatar.setIcon(imagenUser);
    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sysInventory/iconos/entrar.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtUser.getText().equals("admin") && txtPass.getText().equals("admin")) 
        {
            ...
            this.hide();
            setIcono();//insertando el icono de usuario
        ...
        {
            JOptionPane.showMessageDialog(this, "Usuario o password incorrectos..!!", null, JOptionPane.ERROR_MESSAGE);
        }
